...
#include "DAMICPhysicsListMicroElectronics.hh"
...
DAMICPhysicsListMicroElectronics::DAMICPhysicsListMicroElectronics() : G4VUserPhysicsList()
{
...
DAMICPhysicsListMicroElectronics::~DAMICPhysicsListMicroElectronics()
{}

  void DAMICPhysicsListMicroElectronics::ConstructParticle()
  {
  ...
  // construct Bosons://///////////////////////////////////////////////////
  void DAMICPhysicsListMicroElectronics::ConstructMyBosons()
  {
    // pseudo-particles
  ...
  // construct Leptons://///////////////////////////////////////////////////
  void DAMICPhysicsListMicroElectronics::ConstructMyLeptons()
  {
    // leptons
  ...
  // construct Hadrons://///////////////////////////////////////////////////
  void DAMICPhysicsListMicroElectronics::ConstructMyHadrons()
  {
   //  mesons
  ...
  void DAMICPhysicsListMicroElectronics::ConstructMyShortLiveds()
  {
  ...
  // Construct Processes //////////////////////////////////////////////////////
  void DAMICPhysicsListMicroElectronics::ConstructProcess()
  {
  ...
  void DAMICPhysicsListMicroElectronics::AddTransportation() {
...
#include "G4ChipsKaonZeroInelasticXS.hh"
  ...
  void DAMICPhysicsListMicroElectronics::ConstructEM() {
   ...
   theParticleIterator->reset();
    ...
    G4ElectronCapture* ecap = new G4ElectronCapture("Region8", 16.7*eV);
    pmanager->AddDiscreteProcess(ecap);

    // ---> STANDARD EM processes are inactivated below 100 MeV

    G4UrbanMscModel* mscbis =  new G4UrbanMscModel();
    mscbis->SetActivationLowEnergyLimit(100*MeV);
    em_config->SetExtraEmModel("e-","msc",mscbis,"Region8");

    G4VEmModel* mod;
    mod = new G4LivermoreIonisationModel();
    mod->SetActivationLowEnergyLimit(100*MeV);
    em_config->SetExtraEmModel("e-","eIoni",mod,"Region8",0.0,100*GeV, new G4UniversalFluctuation());

    // ---> MicroElec processes activated

    mod = new G4MicroElecElasticModel();
    em_config->SetExtraEmModel("e-","e-_G4MicroElecElastic",mod,"Region8",0.0,100*MeV);

    mod = new G4MicroElecInelasticModel();
    em_config->SetExtraEmModel("e-","e-_G4MicroElecInelastic",mod,"Region8",16.7*eV,100*MeV);
        }
      else if (particleName == "e+")
        {
    //positron
  ...
  void DAMICPhysicsListMicroElectronics::ConstructOp()
  {
  ...
  void DAMICPhysicsListMicroElectronics::ConstructHad()
  {
    //Elastic models
  ...
  void DAMICPhysicsListMicroElectronics::ConstructGeneral() {
...
#include "G4ProductionCuts.hh"
  void DAMICPhysicsListMicroElectronics::SetCuts()
  {

    if (verboseLevel >1)
      G4cout << "DAMICPhysicsListMicroElectronics::SetCuts:";
    ...
    cut1->SetProductionCut(1*mm);
    G4Region* Region1 = G4RegionStore::GetInstance()->GetRegion("Region1");
    Region1->SetProductionCuts(cut1);

    G4ProductionCuts* cut2 = new G4ProductionCuts;
    cut2->SetProductionCut(1*mm);
    G4Region* Region2 = G4RegionStore::GetInstance()->GetRegion("Region2");
    Region2->SetProductionCuts(cut2);

    G4ProductionCuts* cut3 = new G4ProductionCuts;
    cut3->SetProductionCut(100*um);
    G4Region* Region3 = G4RegionStore::GetInstance()->GetRegion("Region3");
    Region3->SetProductionCuts(cut3);

    G4ProductionCuts* cut4 = new G4ProductionCuts;
    cut4->SetProductionCut(1*mm);
    G4Region* Region4 = G4RegionStore::GetInstance()->GetRegion("Region4");
    Region4->SetProductionCuts(cut4);

    G4ProductionCuts* cut5 = new G4ProductionCuts;
    cut5->SetProductionCut(100*um);
    G4Region* Region5 = G4RegionStore::GetInstance()->GetRegion("Region5");
    Region5->SetProductionCuts(cut5);
    

    G4ProductionCuts* cut6 = new G4ProductionCuts;
    cut6->SetProductionCut(10*um); // 100 um ?
    G4Region* Region6 = G4RegionStore::GetInstance()->GetRegion("Region6");
    Region6->SetProductionCuts(cut6);

    G4ProductionCuts* cut7 = new G4ProductionCuts;
    cut7->SetProductionCut(10*um);
    G4Region* Region7 = G4RegionStore::GetInstance()->GetRegion("Region7");
    Region7->SetProductionCuts(cut7);
